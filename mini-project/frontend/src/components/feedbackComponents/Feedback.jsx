        ...
        <section className="feedback-hero">
          <div className="hero-content">
            ...
            <p className="hero-subtitle animate-fade-in-up delay-200">
              Help us improve Health AI by sharing your thoughts, suggestions,
              and experiences
            </p>
          </div>
        </section>
          ...
          <div className="feedback-container">
            <div className="feedback-info">
              ...
              <p className="section-subtitle">
                Your feedback helps us enhance our AI-powered health prediction
                system and provide better user experience.
              </p>
              ...
              <div className="feedback-features">
                <div className="feature-item">
                  ...
                  <p>
                    Share your thoughts and suggestions directly with our team
                  </p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="feedback-form">
                ...
                {submitStatus === "success" && (
                  <div className="success-message">
                    ...
                    <h4>Thank You!</h4>
                    <p>
                      Your feedback has been sent successfully. We'll review it
        ...
        <section className="contact-section">
          <div className="contact-card">
            <div className="contact-info">
              ...
              <p>
                Prefer to contact us directly? Here are alternative ways to get
                in touch.
              </p>
